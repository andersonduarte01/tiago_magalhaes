...
$sql = "SELECT login, valor, status, data_pagamento, payment_id FROM pagamentos WHERE iduser = " . $iduser . " OR byid = " . $iduser . " LIMIT " . $startFrom . ", " . $resultsPerPage;
...
$sqlCount = "SELECT COUNT(*) AS total FROM pagamentos WHERE iduser = " . $iduser . " OR byid = " . $iduser;

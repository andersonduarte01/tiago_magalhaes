...
$sql = "SELECT login, valor, status, data_pagamento, payment_id FROM pagamentos LIMIT " . $startFrom . ", " . $resultsPerPage;
...
$sqlCount = "SELECT COUNT(*) AS total FROM pagamentos";

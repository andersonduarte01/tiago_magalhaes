...
include "../../menu.php";
echo "\r\n            <center>\r\n                <div class=\"container-fluid py-5\">\r\n                    <div class=\"col-lg-12\">\r\n                        <!-- Inicio -->\r\n\r\n                        <h2 class=\"card-title\">Usuários Expirado</h2><br>\r\n                                ";
if (isset($_SESSION["excluidocomsucesso"])) {
    echo "<script>Swal.fire({ icon: 'success', title: 'Sucesso!', html: '" . $_SESSION["excluidocomsucesso"] . "' });</script>";
    unset($_SESSION["excluidocomsucesso"]);
}
echo "                                ";
...
$sql = "SELECT id, byid, categoriaid, login, senha, limite, expira FROM ssh_accounts WHERE byid = ? AND expira < NOW()";
...
$searchName = isset($_GET["searchName"]) ? $_GET["searchName"] : "";
echo "                                    \r\n                                    <form class=\"form-inline my-3\" action=\"\" method=\"GET\">\r\n                                    <div class=\"d-flex flex-wrap\">\r\n                                        <div class=\"input-group-append mb-2 flex-fill\">\r\n                                            <a href=\"excluir.php?id=";
echo $id;
echo "\" class=\"btn btn-danger btn-dm\">Excluir expirados</a>\r\n                                        </div>\r\n                                        ";
if ($_SESSION["nivel"] == 3) {
    echo "                                            <div class=\"input-group-append mb-2 flex-fill\">\r\n                                                <a href=\"excluirglobal.php\" class=\"btn btn-danger btn-dm\">Excluir Global</a>\r\n                                            </div>\r\n                                        ";
}
...
$sqlCount = "SELECT COUNT(*) AS total FROM ssh_accounts WHERE byid = " . $_SESSION["iduser"] . " AND expira < NOW()";
if (!empty($searchName)) {
...
$maxVisibleButtons = 5 < $totalResults ? 5 : $totalResults;
...
if ($page < $totalPages && 1 < $totalResults) {
    echo "                                    <li class=\"page-item mx-4\">\r\n                                        <a class=\"page-link\" href=\"?page=";
    echo $page + 1;
    echo "\">\r\n                                            Próxima\r\n                                        </a>\r\n                                    </li>\r\n                                    ";
}

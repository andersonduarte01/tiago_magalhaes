...
include "../../menu.php";
echo "\r\n\r\n            <center>\r\n                <div class=\"container-fluid py-5\">\r\n                    <div class=\"col-lg-12\">\r\n                        <!-- Inicio -->\r\n\r\n                        <h2 class=\"card-title\">Lista de Usuários</h2><br><br>\r\n                        \r\n                         ";
...
echo "                                \r\n                                 ";
if (isset($_SESSION["errornão"])) {
    echo "<script>Swal.fire({ icon: 'error', title: 'Erro!', html: '" . $_SESSION["errornão"] . "' });</script>";
    unset($_SESSION["errornão"]);
}
echo "                                \r\n                                     ";
$page = isset($_GET["page"]) ? $_GET["page"] : 1;
$resultsPerPage = isset($_GET["showAll"]) ? 1000000 : 10;
$startFrom = ($page - 1) * $resultsPerPage;
$searchName = isset($_GET["searchName"]) ? $_GET["searchName"] : "";
$sql = "SELECT id, byid, categoriaid, login, senha, limite, expira FROM ssh_accounts WHERE byid = ?";
...
if (0 < $result->num_rows) {
    while ($atribuidos = $result->fetch_assoc()) {
        ...
        echo $categoriaNome;
        echo "</h5> \r\n                                                                   <div style=\"margin-left: 7px;\">\r\n                                                                        <a href=\"deviceid.php?id=";
        echo $atribuidos["id"];
        echo "\" class=\"btn btn-primary btn-sm\" style=\"background-color: #5e17eb; padding: 4px 4px; font-size: 10px; lefet\">Limpar DeviceId</a>\r\n                                                                    </div>\r\n                                                                </div>\r\n                                                                \r\n                                                            </div>\r\n                                                            <img src=\"https://cdn-icons-png.flaticon.com/512/3064/3064224.png\" style=\"height: 55px;position: absolute;right: 7px;top: 13px; opacity: 0.3;\">\r\n                                                        </div>\r\n                                                          ";
        $hoje = new DateTime();
...
$sqlCount = "SELECT COUNT(*) AS total FROM ssh_accounts WHERE byid = " . $_SESSION["iduser"];
if (!empty($searchName)) {
